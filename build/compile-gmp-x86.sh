...
export TARGET32="android-${MVERSION}"
...
export TARGET64="android-${MVERSION}"
...
./configure --prefix=/usr --enable-cxx --build=x86_64-pc-linux-gnu --host=i686-linux-android MPN_PATH="x86/atom/sse2 x86/atom/mmx x86/atom x86/mmx x86 generic" || exit 1
...
./configure --prefix=/usr --enable-cxx --build=x86_64-pc-linux-gnu --host=x86_64-linux-android MPN_PATH="x86_64/pentium4 x86_64/fastsse x86_64/k8 x86_64 generic" || exit 1
sed -i.bak '/HAVE_LOCALECONV 1/d' ./config.h
