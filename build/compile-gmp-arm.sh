...
./configure --prefix=/usr  --enable-cxx --build=x86_64-pc-linux-gnu --host=arm-linux-androideabi MPN_PATH="arm/v6t2 arm/v6 arm/v5 arm generic"
sed -i.bak '/HAVE_LOCALECONV 1/d' ./config.h
...
./configure --prefix=/usr  --enable-cxx --build=x86_64-pc-linux-gnu --host=arm-linux-androideabi MPN_PATH="arm/v5 arm generic"
sed -i.bak '/HAVE_LOCALECONV 1/d' ./config.h
